"""
src/experiments/test_cpoe_only.py

Tests CPOE in isolation: adds pregame off_cpoe/def_cpoe_allowed to the
existing production feature set, leaving blended off_epa_per_play/
def_epa_per_play untouched. No pass/rush split involved.

Run: python -m src.experiments.test_cpoe_only
"""
...
NEW_STAT_COLS = ["pregame_off_cpoe", "pregame_def_cpoe_allowed"]
...
def main():
    ...
    for name, make_fns in [
        ...
        ext = run_model(make_fns, df, extended_cols)
