"""
src/experiments/bootstrap_rf_adjusted_ratings_test.py

Tests whether RF's away-score improvement from adjusted ratings is real.

Run: python -m src.experiments.bootstrap_rf_adjusted_ratings_test
"""
...
def main():
    base_results = pd.read_parquet("data/processed/adjrating_base_rf.parquet")
    ext_results = pd.read_parquet("data/processed/adjrating_ext_rf.parquet")
