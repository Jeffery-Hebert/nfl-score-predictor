"""
src/experiments/bootstrap_adjusted_ratings_test.py

Tests whether the Poisson GLM improvement from adjusted ratings is real
or noise, using the saved base/extended prediction files.

Run: python -m src.experiments.bootstrap_adjusted_ratings_test
"""
...
def main():
    base_results = pd.read_parquet("data/processed/adjrating_base_poisson.parquet")
    ext_results = pd.read_parquet("data/processed/adjrating_ext_poisson.parquet")
